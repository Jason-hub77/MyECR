...
pipeline {
    agent any
    environment {
        ECR_REGISTRY = "897139486224.dkr.ecr.us-east-1.amazonaws.com"
...
```bash
aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin docker run --name todo -dp 80:3000 897139486224.dkr.ecr.us-east-1.amazonaws.com/clarusway/to-do-app:latest.dkr.ecr.us-east-1.amazonaws.com
```

- Then run the image

```bash
docker run --name todo -dp 80:3000 897139486224.dkr.ecr.us-east-1.amazonaws.com/clarusway/to-do-app:latest
```
